...
# To remove this error: 'Unsupported media type "text/plain" in request.' -> we will use content-Type
...
def get_data(id=None):
    ...
    r = requests.get(url = URL, headers=headers, data = json_data) # with GET request, JSON data will be submitted to URL
    data = r.json()
    print("➡ data :", data)

# get_data() # to test "GET" api, uncomment this one
